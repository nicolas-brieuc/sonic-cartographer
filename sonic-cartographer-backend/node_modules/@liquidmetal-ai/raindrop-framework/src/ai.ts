...
export const MODEL_CATALOG = [
  ...
  },
  {
    ...
    description: 'External model routed through model-router: deepseek-v3.1'
  },
  {
    name: 'deepseek-v3.1-terminus',
    capability: ['chat'],
    provider: 'external',
    providerModel: 'deepseek-v3.1-terminus',
    description: 'External model routed through model-router: deepseek-v3.1-terminus'
  },
  {
  ...
  },
  {
    ...
    description: 'External model routed through model-router: gpt-oss-120b'
  },
  {
  ...
  },
  {
    ...
    capability: ['audio'],
    provider: 'external',
    providerModel: 'whisper-large-v3-turbo',
    description: 'External model routed through model-router: whisper-large-v3-turbo'
  },
  {
    name: 'llama-guard-4-12b',
    capability: ['chat'],
    provider: 'external',
    providerModel: 'llama-guard-4-12b',
    description: 'External model routed through model-router: llama-guard-4-12b'
  },
  {
    name: 'kimi-k2',
    capability: ['chat'],
  ...
  },
  {
    ...
    description: 'External model routed through model-router: gpt-oss-20b'
  },
  {
    name: 'embeddings',
  ...
  {
    name: 'glm-4.6-ludicrous',
    capability: ['chat'],
    provider: 'external',
    providerModel: 'glm-4.6-ludicrous',
    description: 'External model routed through model-router: glm-4.6-ludicrous',
    rateLimits: {
  ...
  },
  {
    ...
    description: 'External model routed through model-router: glm-4.6'
  },
  {
    name: 'smart-turn-v2',
    capability: ['audio'],
  ...
  },
  {
    ...
    capability: ['embeddings'],
    provider: 'cloudflare',
    providerModel: '@cf/qwen/qwen3-embedding-0.6b',
  ...
  },
  {
    ...
    capability: ['tts'],
    provider: 'cloudflare',
    providerModel: '@cf/deepgram/aura-2-es',
  ...
  },
  {
    ...
    capability: ['embeddings'],
    provider: 'cloudflare',
    providerModel: '@cf/pfnet/plamo-embedding-1b',
  ...
  },
  {
    ...
    capability: ['audio'],
    provider: 'cloudflare',
    providerModel: '@cf/deepgram/flux',
  ...
  },
  {
    ...
    capability: ['chat'],
    provider: 'cloudflare',
    providerModel: '@cf/ibm-granite/granite-4.0-h-micro',
  ...
  },
  {
    ...
    capability: ['translation'],
    provider: 'cloudflare',
    providerModel: '@cf/ai4bharat/indictrans2-en-indic-1B',
  ...
  },
  {
    ...
    capability: ['chat'],
    provider: 'cloudflare',
    providerModel: '@cf/aisingapore/gemma-sea-lion-v4-27b-it',
  ...
  },
  {
    ...
    capability: ['tts'],
    provider: 'cloudflare',
    providerModel: '@cf/deepgram/aura-2-en',
    description: 'Aura-2 is a context-aware text-to-speech (TTS) model that applies natural pacing, expressiveness, and fillers based on the context of the provided text. The quality of your text input directly impacts the naturalness of the audio output.'
  },
  {
...
export function getModelsByCapability(capability: ModelCapability): ModelCatalogEntry[] {
  return MODEL_CATALOG.filter(model => (model.capability as readonly ModelCapability[]).includes(capability));
}
...
export interface AudioInput {
  audio: number[] | ReadableStream; // Audio data as number array for RPC serialization or ReadableStream for large files
...
export type AiInput3 = (InputQueryAndContexts | InputEmbedding | {
/**
 * Batch of the embeddings requests to run using async-queue
 */
requests: (InputQueryAndContexts1 | InputEmbedding1)[]
})

export interface InputQueryAndContexts {
/**
...
export interface InputEmbedding {
text: (string | string[])
/**
 * When provided with too long context should the model error out or truncate the context to fit?
 */
...
export interface InputQueryAndContexts1 {
/**
 * A query you wish to perform against the provided contexts. If no query is provided the model with respond with embeddings for contexts
 */
query?: string
...
export interface InputEmbedding1 {
text: (string | string[])
/**
 * When provided with too long context should the model error out or truncate the context to fit?
 */
...
export type AiOutput3 = (OuputQuery | OutputEmbeddingForContexts | OuputEmbedding)

export interface OuputQuery {
response?: {
/**
...
export interface OutputEmbeddingForContexts {
response?: number[][]
shape?: number[]
/**
...
export interface OuputEmbedding {
shape?: number[]
/**
 ...
 */
export type AiOutput8 = string

export type AiInput9 = (string | {
/**
...
export type AiInput17 = (_cf_meta_llama_3_3_70b_instruct_fp8_fast_AiInput17_Prompt | _cf_meta_llama_3_3_70b_instruct_fp8_fast_AiInput17_Messages | AsyncBatch)

export interface _cf_meta_llama_3_3_70b_instruct_fp8_fast_AiInput17_Prompt {
/**
 * The input text prompt for the model to generate a response.
 */
prompt: string
...
export interface _cf_meta_llama_3_3_70b_instruct_fp8_fast_AiInput17_JSONMode {
type?: ("json_object" | "json_schema")
json_schema?: any
}
export interface _cf_meta_llama_3_3_70b_instruct_fp8_fast_AiInput17_Messages {
/**
 * An array of message objects representing the conversation history.
 */
messages: {
...
export interface _cf_meta_llama_3_3_70b_instruct_fp8_fast_AiInput17_JSONMode1 {
type?: ("json_object" | "json_schema")
json_schema?: any
}
 ...
 */
export type AiOutput18 = string

export type AiInput19 = ({
/**
...
export type AiInput22 = (_cf_qwen_qwen2_5_coder_32b_instruct_AiInput22_Prompt | _cf_qwen_qwen2_5_coder_32b_instruct_AiInput22_Messages)

export interface _cf_qwen_qwen2_5_coder_32b_instruct_AiInput22_Prompt {
/**
 * The input text prompt for the model to generate a response.
 */
prompt: string
...
export interface _cf_qwen_qwen2_5_coder_32b_instruct_AiInput22_JSONMode {
type?: ("json_object" | "json_schema")
json_schema?: any
}
export interface _cf_qwen_qwen2_5_coder_32b_instruct_AiInput22_Messages {
/**
 * An array of message objects representing the conversation history.
 */
messages: {
...
export interface _cf_qwen_qwen2_5_coder_32b_instruct_AiInput22_JSONMode1 {
type?: ("json_object" | "json_schema")
json_schema?: any
}

export type AiInput23 = (_cf_aisingapore_gemma_sea_lion_v4_27b_it_AiInput23_Prompt | _cf_aisingapore_gemma_sea_lion_v4_27b_it_AiInput23_Messages | _cf_aisingapore_gemma_sea_lion_v4_27b_it_AiInput23_AsyncBatch)

export interface _cf_aisingapore_gemma_sea_lion_v4_27b_it_AiInput23_Prompt {
/**
 * The input text prompt for the model to generate a response.
 */
prompt: string
...
export interface _cf_aisingapore_gemma_sea_lion_v4_27b_it_AiInput23_JSONMode {
type?: ("json_object" | "json_schema")
json_schema?: any
}
export interface _cf_aisingapore_gemma_sea_lion_v4_27b_it_AiInput23_Messages {
/**
 * An array of message objects representing the conversation history.
 */
messages: {
...
export interface _cf_aisingapore_gemma_sea_lion_v4_27b_it_AiInput23_JSONMode1 {
type?: ("json_object" | "json_schema")
json_schema?: any
}
export interface _cf_aisingapore_gemma_sea_lion_v4_27b_it_AiInput23_AsyncBatch {
...
export interface _cf_aisingapore_gemma_sea_lion_v4_27b_it_AiInput23_JSONMode2 {
type?: ("json_object" | "json_schema")
json_schema?: any
}
...
// Note: This type excludes AsyncResponse variants which are handled by the queueRequest option
export type AiOutput22 = (ChatCompletionResponse | TextCompletionResponse)
...
export type AiInput26 = (_cf_mistralai_mistral_small_3_1_24b_instruct_AiInput26_Prompt | _cf_mistralai_mistral_small_3_1_24b_instruct_AiInput26_Messages)

export interface _cf_mistralai_mistral_small_3_1_24b_instruct_AiInput26_Prompt {
/**
 * The input text prompt for the model to generate a response.
 */
prompt: string
...
export interface _cf_mistralai_mistral_small_3_1_24b_instruct_AiInput26_Messages {
/**
 * An array of message objects representing the conversation history.
 */
messages: {
...
export type AiInput27 = (_cf_meta_llama_3_2_11b_vision_instruct_AiInput27_Prompt | _cf_meta_llama_3_2_11b_vision_instruct_AiInput27_Messages)

export interface _cf_meta_llama_3_2_11b_vision_instruct_AiInput27_Prompt {
/**
 * The input text prompt for the model to generate a response.
 */
prompt: string
...
export interface _cf_meta_llama_3_2_11b_vision_instruct_AiInput27_Messages {
/**
 * An array of message objects representing the conversation history.
 */
messages: {
...
export type AiInput34 = (_cf_meta_llama_4_scout_17b_16e_instruct_AiInput34_Prompt | _cf_meta_llama_4_scout_17b_16e_instruct_AiInput34_Messages | Async_Batch)

export interface _cf_meta_llama_4_scout_17b_16e_instruct_AiInput34_Prompt {
/**
 * The input text prompt for the model to generate a response.
 */
prompt: string
...
export interface _cf_meta_llama_4_scout_17b_16e_instruct_AiInput34_JSONMode {
type?: ("json_object" | "json_schema")
json_schema?: any
}
export interface _cf_meta_llama_4_scout_17b_16e_instruct_AiInput34_Messages {
/**
 * An array of message objects representing the conversation history.
 */
messages: {
...
export interface _cf_meta_llama_4_scout_17b_16e_instruct_AiInput34_JSONMode1 {
type?: ("json_object" | "json_schema")
json_schema?: any
}
export interface Async_Batch {
requests: (Prompt_Inner | Messages_Inner)[]
}
export interface Prompt_Inner {
/**
 * The input text prompt for the model to generate a response.
 */
prompt: string
...
export interface _cf_meta_llama_4_scout_17b_16e_instruct_AiInput34_JSONMode2 {
type?: ("json_object" | "json_schema")
json_schema?: any
}
export interface Messages_Inner {
/**
 * An array of message objects representing the conversation history.
 */
messages: {
...
export interface _cf_meta_llama_4_scout_17b_16e_instruct_AiInput34_JSONMode3 {
type?: ("json_object" | "json_schema")
json_schema?: any
}
...
export type AiInput35 = (_cf_google_gemma_3_12b_it_AiInput35_Prompt | _cf_google_gemma_3_12b_it_AiInput35_Messages)

export interface _cf_google_gemma_3_12b_it_AiInput35_Prompt {
/**
 * The input text prompt for the model to generate a response.
 */
prompt: string
...
export interface _cf_google_gemma_3_12b_it_AiInput35_Messages {
/**
 * An array of message objects representing the conversation history.
 */
messages: {
...
export type AiInput37 = (_cf_meta_llama_3_1_70b_instruct_AiInput37_Prompt | _cf_meta_llama_3_1_70b_instruct_AiInput37_Messages)

export interface _cf_meta_llama_3_1_70b_instruct_AiInput37_Prompt {
/**
 * Decreases the likelihood of the model repeating the same lines verbatim.
 */
frequency_penalty?: number
...
export interface _cf_meta_llama_3_1_70b_instruct_AiInput37_Messages {
/**
 * Decreases the likelihood of the model repeating the same lines verbatim.
 */
frequency_penalty?: number
...
type _cf_qwen_qwen3_embedding_0_6b_Input = AiInput6;
type _cf_meta_llama_2_7b_chat_fp16_Input = AiInput2;
type _cf_mistral_mistral_7b_instruct_v0_1_Input = AiInput2;
type _cf_myshell_ai_melotts_Input = AiInput7;
type _cf_mistral_mistral_7b_instruct_v0_2_lora_Input = AiInput2;
type _cf_deepgram_aura_2_es_Input = AiInput8;
type _cf_openai_whisper_Input = AiInput9;
type _cf_tinyllama_tinyllama_1_1b_chat_v1_0_Input = AiInput2;
type _cf_pfnet_plamo_embedding_1b_Input = AiInput10;
type _hf_mistral_mistral_7b_instruct_v0_2_Input = AiInput2;
type _cf_fblgit_una_cybertron_7b_v2_bf16_Input = AiInput2;
type _cf_llava_hf_llava_1_5_7b_hf_Input = AiInput11;
type _cf_deepseek_ai_deepseek_r1_distill_qwen_32b_Input = AiInput2;
type _cf_runwayml_stable_diffusion_v1_5_inpainting_Input = AiInput12;
type _cf_deepgram_flux_Input = AiInput13;
type _cf_deepgram_nova_3_Input = AiInput14;
type _cf_black_forest_labs_flux_1_schnell_Input = AiInput15;
...
type _cf_microsoft_resnet_50_Input = AiInput16;
type _cf_bytedance_stable_diffusion_xl_lightning_Input = AiInput12;
type _hf_thebloke_deepseek_coder_6_7b_base_awq_Input = AiInput2;
type _cf_meta_llama_llama_2_7b_chat_hf_lora_Input = AiInput2;
type _cf_meta_llama_3_3_70b_instruct_fp8_fast_Input = AiInput17;
type _cf_ibm_granite_granite_4_0_h_micro_Input = AiInput2;
type _cf_lykon_dreamshaper_8_lcm_Input = AiInput12;
type _cf_leonardo_phoenix_1_0_Input = AiInput18;
type _cf_stabilityai_stable_diffusion_xl_base_1_0_Input = AiInput12;
type _hf_thebloke_openhermes_2_5_mistral_7b_awq_Input = AiInput2;
type _cf_meta_m2m100_1_2b_Input = AiInput19;
type _cf_ai4bharat_indictrans2_en_indic_1B_Input = AiInput20;
type _hf_thebloke_deepseek_coder_6_7b_instruct_awq_Input = AiInput2;
type _cf_baai_bge_small_en_v1_5_Input = AiInput21;
type _cf_qwen_qwen2_5_coder_32b_instruct_Input = AiInput22;
...
type _cf_baai_bge_base_en_v1_5_Input = AiInput21;
type _cf_aisingapore_gemma_sea_lion_v4_27b_it_Input = AiInput23;
type _cf_qwen_qwen3_30b_a3b_fp8_Input = AiInput23;
type _cf_meta_llama_3_1_8b_instruct_awq_Input = AiInput2;
type _cf_unum_uform_gen2_qwen_500m_Input = AiInput24;
type _cf_black_forest_labs_flux_2_dev_Input = AiInput25;
...
type _cf_mistralai_mistral_small_3_1_24b_instruct_Input = AiInput26;
type _cf_meta_llama_3_8b_instruct_awq_Input = AiInput2;
type _cf_meta_llama_3_2_11b_vision_instruct_Input = AiInput27;
type _cf_openai_whisper_tiny_en_Input = AiInput9;
type _cf_openai_whisper_large_v3_turbo_Input = AiInput28;
type _cf_deepgram_aura_1_Input = AiInput29;
type _cf_defog_sqlcoder_7b_2_Input = AiInput2;
type _cf_microsoft_phi_2_Input = AiInput2;
type _cf_facebook_bart_large_cnn_Input = AiInput30;
type _cf_runwayml_stable_diffusion_v1_5_img2img_Input = AiInput12;
type _cf_google_embeddinggemma_300m_Input = AiInput31;
type _cf_baai_bge_reranker_base_Input = AiInput32;
type _hf_google_gemma_7b_it_Input = AiInput2;
type _cf_leonardo_lucid_origin_Input = AiInput33;
type _cf_qwen_qwen1_5_14b_chat_awq_Input = AiInput2;
type _cf_openchat_openchat_3_5_0106_Input = AiInput2;
type _cf_meta_llama_4_scout_17b_16e_instruct_Input = AiInput34;
type _cf_google_gemma_3_12b_it_Input = AiInput35;
type _cf_qwen_qwq_32b_Input = AiInput26;
type _cf_baai_bge_large_en_v1_5_Input = AiInput21;
type _cf_deepgram_aura_2_en_Input = AiInput36;
type _cf_meta_llama_3_1_70b_instruct_Input = AiInput37;
type _cf_meta_llama_3_1_8b_instruct_fast_Input = AiInput37;
type llama_3_3_70b_Input = AiInput38;
type llama_4_maverick_17b_Input = AiInput39;
type llama_3_1_8b_instruct_Input = AiInput40;
type deepseek_r1_Input = AiInput41;
type deepseek_v3_0324_Input = AiInput42;
type deepseek_v3_1_Input = AiInput43;
type deepseek_v3_1_terminus_Input = AiInput44;
type deepseek_r1_distill_llama_70b_Input = AiInput45;
type qwen_3_32b_Input = AiInput46;
type llama_3_3_swallow_70b_Input = AiInput47;
type whisper_large_v3_Input = AiInput48;
type gpt_oss_120b_Input = AiInput49;
type llama_3_1_8b_instant_Input = AiInput50;
type gemma_9b_it_Input = AiInput51;
type whisper_large_v3_turbo_Input = AiInput52;
type llama_guard_4_12b_Input = AiInput53;
type kimi_k2_Input = AiInput54;
type gpt_oss_20b_Input = AiInput55;
type bge_embeddings_Input = AiInput56;
type piiranha_pii_Input = AiInput57;
type glm_4_6_ludicrous_Input = AiInput58;
type glm_4_6_Input = AiInput59;
...
type _cf_qwen_qwen3_embedding_0_6b_Output = AiOutput6;
type _cf_meta_llama_2_7b_chat_fp16_Output = AiOutput2;
type _cf_mistral_mistral_7b_instruct_v0_1_Output = AiOutput2;
type _cf_myshell_ai_melotts_Output = AiOutput7;
type _cf_mistral_mistral_7b_instruct_v0_2_lora_Output = AiOutput2;
type _cf_deepgram_aura_2_es_Output = AiOutput8;
type _cf_openai_whisper_Output = AiOutput9;
type _cf_tinyllama_tinyllama_1_1b_chat_v1_0_Output = AiOutput2;
type _cf_pfnet_plamo_embedding_1b_Output = AiOutput10;
type _hf_mistral_mistral_7b_instruct_v0_2_Output = AiOutput2;
type _cf_fblgit_una_cybertron_7b_v2_bf16_Output = AiOutput2;
type _cf_llava_hf_llava_1_5_7b_hf_Output = AiOutput11;
type _cf_deepseek_ai_deepseek_r1_distill_qwen_32b_Output = AiOutput2;
type _cf_runwayml_stable_diffusion_v1_5_inpainting_Output = AiOutput12;
type _cf_deepgram_flux_Output = AiOutput13;
type _cf_deepgram_nova_3_Output = AiOutput14;
type _cf_black_forest_labs_flux_1_schnell_Output = AiOutput15;
...
type _cf_microsoft_resnet_50_Output = AiOutput16;
type _cf_bytedance_stable_diffusion_xl_lightning_Output = AiOutput12;
...
type _cf_meta_llama_3_3_70b_instruct_fp8_fast_Output = AiOutput17;
type _cf_ibm_granite_granite_4_0_h_micro_Output = AiOutput2;
type _cf_lykon_dreamshaper_8_lcm_Output = AiOutput12;
type _cf_leonardo_phoenix_1_0_Output = AiOutput18;
type _cf_stabilityai_stable_diffusion_xl_base_1_0_Output = AiOutput12;
type _hf_thebloke_openhermes_2_5_mistral_7b_awq_Output = AiOutput2;
type _cf_meta_m2m100_1_2b_Output = AiOutput19;
type _cf_ai4bharat_indictrans2_en_indic_1B_Output = AiOutput20;
type _hf_thebloke_deepseek_coder_6_7b_instruct_awq_Output = AiOutput2;
type _cf_baai_bge_small_en_v1_5_Output = AiOutput21;
...
type _cf_baai_bge_base_en_v1_5_Output = AiOutput21;
type _cf_aisingapore_gemma_sea_lion_v4_27b_it_Output = AiOutput22;
type _cf_qwen_qwen3_30b_a3b_fp8_Output = AiOutput22;
type _cf_meta_llama_3_1_8b_instruct_awq_Output = AiOutput2;
type _cf_unum_uform_gen2_qwen_500m_Output = AiOutput11;
type _cf_black_forest_labs_flux_2_dev_Output = AiOutput23;
...
type _cf_mistralai_mistral_small_3_1_24b_instruct_Output = AiOutput24;
type _cf_meta_llama_3_8b_instruct_awq_Output = AiOutput2;
type _cf_meta_llama_3_2_11b_vision_instruct_Output = AiOutput25;
type _cf_openai_whisper_tiny_en_Output = AiOutput9;
type _cf_openai_whisper_large_v3_turbo_Output = AiOutput26;
type _cf_deepgram_aura_1_Output = AiOutput8;
type _cf_defog_sqlcoder_7b_2_Output = AiOutput2;
type _cf_microsoft_phi_2_Output = AiOutput2;
type _cf_facebook_bart_large_cnn_Output = AiOutput27;
type _cf_runwayml_stable_diffusion_v1_5_img2img_Output = AiOutput12;
type _cf_google_embeddinggemma_300m_Output = AiOutput28;
type _cf_baai_bge_reranker_base_Output = AiOutput29;
type _hf_google_gemma_7b_it_Output = AiOutput2;
type _cf_leonardo_lucid_origin_Output = AiOutput15;
type _cf_qwen_qwen1_5_14b_chat_awq_Output = AiOutput2;
type _cf_openchat_openchat_3_5_0106_Output = AiOutput2;
type _cf_meta_llama_4_scout_17b_16e_instruct_Output = AiOutput30;
type _cf_google_gemma_3_12b_it_Output = AiOutput24;
type _cf_qwen_qwq_32b_Output = AiOutput24;
type _cf_baai_bge_large_en_v1_5_Output = AiOutput21;
type _cf_deepgram_aura_2_en_Output = AiOutput8;
type _cf_meta_llama_3_1_70b_instruct_Output = AiOutput25;
type _cf_meta_llama_3_1_8b_instruct_fast_Output = AiOutput25;
type llama_3_3_70b_Output = AiOutput31;
type llama_4_maverick_17b_Output = AiOutput31;
type llama_3_1_8b_instruct_Output = AiOutput31;
type deepseek_r1_Output = AiOutput31;
type deepseek_v3_0324_Output = AiOutput31;
type deepseek_v3_1_Output = AiOutput31;
type deepseek_v3_1_terminus_Output = AiOutput31;
type deepseek_r1_distill_llama_70b_Output = AiOutput31;
type qwen_3_32b_Output = AiOutput31;
type llama_3_3_swallow_70b_Output = AiOutput31;
type whisper_large_v3_Output = AiOutput32;
type gpt_oss_120b_Output = AiOutput31;
type llama_3_1_8b_instant_Output = AiOutput31;
type gemma_9b_it_Output = AiOutput31;
type whisper_large_v3_turbo_Output = AiOutput32;
type llama_guard_4_12b_Output = AiOutput31;
type kimi_k2_Output = AiOutput31;
type gpt_oss_20b_Output = AiOutput31;
type bge_embeddings_Output = AiOutput33;
type piiranha_pii_Output = AiOutput31;
type glm_4_6_ludicrous_Output = AiOutput31;
type glm_4_6_Output = AiOutput31;
...
export type AiModelInputMap = {
  [K in AvailableModel]: 
    ...
    K extends 'bge-m3' | 'qwen3-embedding-0.6b' | 'plamo-embedding-1b' | 'bge-small-en-v1.5' | 'bge-base-en-v1.5' | 'embeddinggemma-300m' | 'bge-large-en-v1.5' | 'embeddings' ? ({ input: string | string[]; model?: string; encoding_format?: 'float' | 'base64'; dimensions?: number } | { prompt: string }) :
    K extends 'melotts' | 'aura-2-es' | 'aura-1' | 'aura-2-en' ? { text: string; model?: string; voice?: string; speed?: number; response_format?: 'mp3' | 'opus' | 'aac' | 'flac' | 'wav' | 'pcm' } :
    K extends 'smart-turn-v2' | 'whisper' | 'flux' | 'nova-3' | 'whisper-tiny-en' | 'whisper-large-v3-turbo' | 'whisper-large-v3' | 'whisper-large-v3-turbo' ? AudioInput :
    K extends 'stable-diffusion-v1-5-inpainting' | 'flux-1-schnell' | 'stable-diffusion-xl-lightning' | 'dreamshaper-8-lcm' | 'phoenix-1.0' | 'stable-diffusion-xl-base-1.0' | 'flux-2-dev' | 'stable-diffusion-v1-5-img2img' | 'lucid-origin' ? ImageGenerationInput :
    K extends 'distilbert-sst-2-int8' | 'bge-reranker-base' ? TextClassificationInput :
    K extends 'resnet-50' ? ImageClassificationInput :
    K extends 'm2m100-1.2b' | 'indictrans2-en-indic-1B' ? TranslationInput :
    ...
    K extends 'llama-3.3-70b' | 'llama-4-maverick-17b' | 'llama-3.1-8b-external' | 'deepseek-r1' | 'deepseek-v3-0324' | 'deepseek-v3.1' | 'deepseek-v3.1-terminus' | 'deepseek-r1-distill-llama-70b' | 'qwen-3-32b' | 'llama-3.3-swallow-70b' | 'gpt-oss-120b' | 'llama-3.1-8b-instant' | 'gemma-9b-it' | 'llama-guard-4-12b' | 'kimi-k2' | 'gpt-oss-20b' | 'glm-4.6-ludicrous' | 'glm-4.6' ? OpenAIChatInputExternal :
    OpenAIChatInput;
};
...
export type AiModelOutputMap = {
  [K in AvailableModel]: 
    ...
    K extends 'bge-m3' | 'qwen3-embedding-0.6b' | 'plamo-embedding-1b' | 'bge-small-en-v1.5' | 'bge-base-en-v1.5' | 'embeddinggemma-300m' | 'bge-large-en-v1.5' | 'embeddings' ? (OpenAIEmbeddingOutput & { embeddings?: Array<{ embedding: number[] }> }) :
    K extends 'melotts' | 'aura-2-es' | 'aura-1' | 'aura-2-en' ? { audio: ArrayBuffer | Uint8Array; response_format?: string } :
    K extends 'smart-turn-v2' | 'whisper' | 'flux' | 'nova-3' | 'whisper-tiny-en' | 'whisper-large-v3-turbo' | 'whisper-large-v3' | 'whisper-large-v3-turbo' ? OpenAIAudioOutput :
    K extends 'stable-diffusion-v1-5-inpainting' | 'flux-1-schnell' | 'stable-diffusion-xl-lightning' | 'dreamshaper-8-lcm' | 'phoenix-1.0' | 'stable-diffusion-xl-base-1.0' | 'flux-2-dev' | 'stable-diffusion-v1-5-img2img' | 'lucid-origin' ? ImageGenerationOutput :
    K extends 'distilbert-sst-2-int8' | 'bge-reranker-base' ? TextClassificationOutput :
    K extends 'resnet-50' ? ImageClassificationOutput :
    K extends 'm2m100-1.2b' | 'indictrans2-en-indic-1B' ? TranslationOutput :
