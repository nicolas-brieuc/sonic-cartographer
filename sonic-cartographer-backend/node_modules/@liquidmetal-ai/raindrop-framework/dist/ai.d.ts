...
export declare const MODEL_CATALOG: readonly [{
    ...
    readonly name: "glm-4.6-ludicrous";
    readonly capability: readonly ["chat"];
    readonly provider: "external";
    readonly providerModel: "glm-4.6-ludicrous";
    readonly description: "External model routed through model-router: glm-4.6-ludicrous";
    readonly rateLimits: {
        readonly requestsPerSecond: 20;
        readonly tokensPerMinute: 2000000;
    };
}, {
    readonly name: "glm-4.6";
    readonly capability: readonly ["chat"];
    readonly provider: "external";
    readonly providerModel: "glm-4.6";
    readonly description: "External model routed through model-router: glm-4.6";
}, {
    ...
    readonly capability: readonly ["embeddings"];
    readonly provider: "cloudflare";
    readonly providerModel: "@cf/qwen/qwen3-embedding-0.6b";
    ...
    readonly capability: readonly ["chat"];
    readonly provider: "cloudflare";
    readonly providerModel: "@cf/qwen/qwen3-30b-a3b-fp8";
    ...
    readonly name: "flux-2-dev";
    readonly capability: readonly ["image-generation"];
    readonly provider: "cloudflare";
    readonly providerModel: "@cf/black-forest-labs/flux-2-dev";
...
export type AiModelInputMap = {
    [K in AvailableModel]: K extends 'pii-detection' ? {
        prompt: string;
    } : K extends 'bge-m3' | 'qwen3-embedding-0.6b' | 'plamo-embedding-1b' | 'bge-small-en-v1.5' | 'bge-base-en-v1.5' | 'embeddinggemma-300m' | 'bge-large-en-v1.5' | 'embeddings' ? ({
        input: string | string[];
        model?: string;
        encoding_format?: 'float' | 'base64';
        dimensions?: number;
...
export type AiModelOutputMap = {
    ...
    } : K extends 'bge-m3' | 'qwen3-embedding-0.6b' | 'plamo-embedding-1b' | 'bge-small-en-v1.5' | 'bge-base-en-v1.5' | 'embeddinggemma-300m' | 'bge-large-en-v1.5' | 'embeddings' ? (OpenAIEmbeddingOutput & {
        embeddings?: Array<{
            embedding: number[];
        }>;
    }) : K extends 'melotts' | 'aura-2-es' | 'aura-1' | 'aura-2-en' ? {
