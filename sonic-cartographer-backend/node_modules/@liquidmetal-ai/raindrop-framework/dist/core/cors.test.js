...
import { matchOrigin, addCorsHeaders, handlePreflight, createCorsHandler, corsAllowAll, corsDisabled, } from './cors.js';
describe('cors', () => {
    describe('matchOrigin', () => {
        ...
        it('should return null when string does not match', () => {
            ...
            const config = { origin: 'https://other.com' };
            const result = matchOrigin(request, {}, config);
            expect(result).toBeNull();
        });
    ...
    describe('addCorsHeaders', () => {
        ...
        it('should not add credentials header when not configured', () => {
            ...
            const config = { origin: '*', credentials: false };
            const result = addCorsHeaders(mockResponse, request, {}, config);
        ...
        it('should add expose headers when configured', () => {
            ...
            const result = addCorsHeaders(mockResponse, request, {}, config);
            expect(result.headers.get('Access-Control-Expose-Headers')).toBe('X-Custom-Header, X-Another-Header');
        });
        it('should not add expose headers when empty', () => {
            const request = new Request('http://localhost', {
                headers: { origin: 'https://example.com' },
            });
            const config = { origin: '*', exposeHeaders: [] };
            const result = addCorsHeaders(mockResponse, request, {}, config);
    ...
    describe('handlePreflight', () => {
        ...
        it('should use custom maxAge', () => {
            ...
            const config = { origin: '*', maxAge: 3600 };
            const result = handlePreflight(request, {}, config);
    ...
    describe('corsDisabled', () => {
        ...
        it('should throw error when called without response for non-OPTIONS', () => {
            ...
            expect(() => corsDisabled(request, {})).toThrow('corsDisabled called without response for non-OPTIONS request');
        });
