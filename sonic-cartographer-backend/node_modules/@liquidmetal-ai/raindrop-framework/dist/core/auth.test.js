...
describe('auth', () => {
    ...
    beforeEach(async () => {
        ...
        NoWay.mockImplementation(() => mockNoWay);
    ...
    describe('verifyIssuer', () => {
        ...
        it('should handle multiple comma-separated origins', async () => {
            ...
            const nowayCall = NoWay.mock.calls[0][0];
        ...
        it('should log error with issuer mismatch details', async () => {
            ...
            await verifyIssuer(request, env);
            expect(mockLogger.error).toHaveBeenCalledWith(expect.stringContaining('JWT verification failed'));
            expect(mockLogger.error).toHaveBeenCalledWith(expect.stringContaining('wrong-issuer'));
            expect(mockLogger.error).toHaveBeenCalledWith(expect.stringContaining('correct-issuer'));
        });
        it('should handle error during JWT decoding', async () => {
            ...
            const result = await verifyIssuer(request, env);
            expect(result).toBe(true);
            expect(mockLogger.error).toHaveBeenCalledWith('JWT verification failed with error during logging', expect.any(Object));
        });
