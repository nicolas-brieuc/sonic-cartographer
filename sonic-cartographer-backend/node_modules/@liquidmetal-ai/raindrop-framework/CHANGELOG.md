...
- Updated dependencies [b4beb05]
  - @liquidmetal-ai/noway@0.5.0
...
- Updated dependencies [87af0d1]
  - @liquidmetal-ai/noway@0.2.1
...
- Updated dependencies [d1b1df0]
  - @liquidmetal-ai/noway@0.2.0

## 0.8.1

### Patch Changes

- Critical bugfix for script bindings.
- Updated dependencies
  - @liquidmetal-ai/noway@0.1.1

## 0.8.0

### Minor Changes

- Version 0.8.0 -- WorkOS integration, app bundle hooks, CLI improvements.

### Patch Changes

- Updated dependencies
  - @liquidmetal-ai/noway@0.1.0
