// SQL Schema for main-database SmartSQL resource
...
CREATE INDEX IF NOT EXISTS idx_listening_exp_user_id ON listening_experiences(user_id);
CREATE INDEX IF NOT EXISTS idx_listening_exp_recommendation_id ON listening_experiences(recommendation_id);
