    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-12 bg-[#1a1a1a] relative overflow-hidden">
      ...
      <div className="max-w-md w-full relative z-10">
        ...
        <div className="bg-[#202020] border-4 border-white p-8">
          ...
          <div className="space-y-3 mb-6">
            <button
              ...
              disabled={isLoading}
              className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-white border-2 border-white hover:bg-gray-100 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
            >
              ...
              <span className="text-gray-700 uppercase tracking-wide text-sm">Continue with Google</span>
            </button>
        ...
        <p className="text-xs text-center text-gray-600 mt-6 uppercase tracking-wide">
          ...
          <a href="#" className="text-[#ff0055] hover:text-white">Terms</a>
          {' '}and{' '}
          <a href="#" className="text-[#ff0055] hover:text-white">Privacy</a>
        </p>
      </div>
    </div>
  );
